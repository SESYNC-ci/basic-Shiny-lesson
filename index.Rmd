...
> Reorganize your application using `navbarPage()` for top level navigation and the [sidebar layout](http://shiny.rstudio.com/reference/shiny/latest/sidebarLayout.html). Define a first panel called "Plot" that includes the input widget and plot. Place the input widget in the sidebar and the plot in the main panel. 
